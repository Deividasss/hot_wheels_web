...
const RacingScreen = () => {
    ...
    return (
        <div>
            <p className='collectionTitle w-full my-2 text-[90px] sm:text-[90px] text-center animate__animated animate__pulse animate__slow animate__infinite'>Racing...</p>
            <div className="sm:flex justify-center mt-10 align-middle">
                <div>
                    <img className='w-[130px] m-auto h-[70px] sm:w-[300px] sm:h-[180px]' src={gameCtx.selectedCar.image}></img>
                    <p className='collectionTitle my-2 mx-5 text-[25px] sm:text-[35px] text-center'>Deividas</p>
                </div>
                <p className='collectionTitle my-2 mx-5 text-[90px] sm:text-[70px] text-center'>VS</p>
                <div>
                    <img className='w-[130px] m-auto h-[70px] sm:w-[300px] sm:h-[180px]' src={gameCtx.selectedCar.image}></img>
                    <p className='collectionTitle my-2 mx-5 text-[25px] sm:text-[35px] text-center'>Deividas</p>
                </div>
