        ...
        <>
            ...
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen md:pt-10 transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'
                ...
                <div class="h-full px-3 pb-4 overflow-y-auto sidebar">
                    <button onClick={toggleSidebar} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center m-5 p-2 ml-3 text-sm rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-600 dark:text-gray-400 dark:hover:bg-[#C95500]">
                        <span class="sr-only">Open sidebar</span>
                    ...
                    <ul class="space-y-2 font-bold">
                        <li>
                            <a href="gamescreen" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-[#C95500] group">
                                ...
                                <span class="ml-3">Play And Earn!</span>
                            </a>
                        </li>
                        <li>
